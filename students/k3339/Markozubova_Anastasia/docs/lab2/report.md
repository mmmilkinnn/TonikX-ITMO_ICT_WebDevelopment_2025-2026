...
## Тема: Веб-приложение «Доска домашних заданий» на Django (локальный запуск без Docker)

В ходе лабораторной работы был разработан и оформлен полноценный веб-сервис **«Доска домашних заданий»**, реализованный на фреймворке **Django** с использованием локальной базы данных **SQLite**.  
...
Сайт оформлен в тёплой **оранжево-жёлто-красной палитре**, подчёркивающей учебную атмосферу и придающей интерфейсу современный и дружелюбный вид.
...
**Результат:**  
Готовый Django-проект с приложением `board`, локальной базой `db.sqlite3`, панелью администратора и страницами для студентов и преподавателей.  
